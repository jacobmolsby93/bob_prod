    ...
    <Box className="row">
      ...
      <Box>
        ...
        <AnimatedBox>
          <Box mt="3rem">
            <Typography variant="h3" className="subtitle-font">
              Renovera köket med bob I stockholm
            </Typography>
            <Box display="flex" mt="2rem">
              ...
              <p className="body-paragraph">
                ...
                <br />
                <br />
                Ytans storlek, placering och form är avgörande när det kommer
                till kökets helhetsintryck, ljusinsläppet spelar stor roll när
                det kommer till ögats intryck och materialet samspelar med
                övriga rum i en bostad. Att ha koll på de viktigaste
                grundpelarna (med hänsyn till boendets förutsättningar) ger ofta
                en fantastisk bra grund när det kommer till just din
                köksplanering. Är du osäker eller behöver hjälp med att veta
                just dina behovsområden? Tveka inte på att fråga, självklart
                bistår vi på BOB med rådgivning där vi kan inflika med vår
                expertis gällande renovering av kök, badrum samt lägenheten i
                sin helhet.
              </p>
            </Box>
          </Box>
        ...
        <AnimatedBox>
          <Box mt="3rem">
            <Typography variant="h3" className="subtitle-font">
              Begär en offert från oss, du kan även ringa oss vi erbjuder fri
              rådgivning
            </Typography>
            <Box display="flex" mt="2rem">
              <span
              ...
              ></span>
              <p className="body-paragraph">
                På tal om expertis så är vår största rekommendation att, i
                samtliga fall rörande köksrenovering, ta hjälp av våra experter
                vilka ser detaljer som en annan inte kan se, ens med blotta
                ögat. De väger kökets för och nackdelar mot varandra och ger dig
                den realistiska planen du behöver ha för att genomföra dina
                specifika önskemål. Våra experter ser helt enkelt till att ge
                dig underlag för att slippa göra onödiga misstag på vägen när du
                ska påbörja att renovera köket.
                <br />
                <br />
                ...
                kan verka omfattande, men med rätt hjälp på rätt plats, så blir
                projektet effektiv och smärtfritt.
                <br />
                <br />

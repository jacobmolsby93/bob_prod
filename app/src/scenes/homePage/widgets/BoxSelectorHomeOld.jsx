    ...
    <Box className="wrapper why-us-wrapper" minHeight="70vh">
      ...
      >
        <Box className="row flex-centerd-align" height="100%">
          ...
          <Box display="flex" className="col-12" justifyContent="space-evenly">
              <GridItem
                src={sketch}
                sx={{
                  backgroundColor: "#ECEAE8",
                ...
                text="Besiktning"
              />
              <GridItem src={quality} alt="Logo Quality" text="Egenkontroller" />
              <GridItem src={teamwork} alt="Logo hands shake" text="Hög tillgänglighet" />
              <GridItem src={podium} alt="Logo podium" text="100% Nöjda Kunder" />
              <GridItem src={podium} alt="Logo podium" text="100% Nöjda Kunder" />
            </Box>
        </Box>
        <Box
